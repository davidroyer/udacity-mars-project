...
4. Run `yarn start` in your terminal and go to `http:localhost:4000` to check that your app is working. If you don't see an image on the page, check that your api key is set up correctly.
