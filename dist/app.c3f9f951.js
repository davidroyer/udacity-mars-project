...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/components/Header/RoverSelect.js":[function(require,module,exports) {
"use strict";
...
const RoverSelect = state => {
  ...
  const RoverSelectOptions = rovers.map(rover => {
...
var _RoverSelect = _interopRequireDefault(require("./RoverSelect"));
...
var _default = Header;
exports.default = _default;
},{"./RoverSelect":"js/components/Header/RoverSelect.js"}],"js/components/Main/RoverImagesSection.js":[function(require,module,exports) {
"use strict";
...
var _default = RoverImagesSection;
exports.default = _default;
},{}],"js/components/Main/RoverInfoSection.js":[function(require,module,exports) {
"use strict";
...
var _RoverImagesSection = _interopRequireDefault(require("./RoverImagesSection"));

var _RoverInfoSection = _interopRequireDefault(require("./RoverInfoSection"));
  ...
  return `
    <main class="pb-16 mt-6 mb-6">
      <div class="max-w-4xl px-4 mx-auto main-content-wrapper">
        <!-- Rover Info -->
        ${(0, _RoverInfoSection.default)(selectedRover)}

        <!-- Rover Images -->
        ${(0, _RoverImagesSection.default)(selectedRover.photos)}
      </div>
    </main>
  `;
};
...
var _default = Main;
exports.default = _default;
},{"./RoverImagesSection":"js/components/Main/RoverImagesSection.js","./RoverInfoSection":"js/components/Main/RoverInfoSection.js"}],"../../node_modules/immutable/dist/immutable.es.js":[function(require,module,exports) {
"use strict";
...
exports.updateState = exports.getStateJS = exports.getState = void 0;

var _immutable = require("immutable");

let state = (0, _immutable.fromJS)({
...
exports.getStateJS = getStateJS;

const updateState = ({
  key,
  value
}) => {
  state = state.set(key, (0, _immutable.fromJS)(value));
};

exports.updateState = updateState;
},{"immutable":"../../node_modules/immutable/dist/immutable.es.js"}],"js/app.js":[function(require,module,exports) {
"use strict";

var _Index = _interopRequireDefault(require("./components/Header/Index"));

var _Index2 = _interopRequireDefault(require("./components/Main/Index"));
...
const siteURL = "development" === 'production' ? 'https://mars-rovers-dashboard.herokuapp.com' : 'http://localhost:3000';
...
const App = state => {
  ...
  return `
    ${(0, _Index.default)(state)}
    ${(0, _Index2.default)(selectedRover)}
  `;
};

window.addEventListener('load', () => {
  render(root, (0, _store.getStateJS)());
});
...
},{"./components/Header/Index":"js/components/Header/Index.js","./components/Main/Index":"js/components/Main/Index.js","./store":"js/store.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
